...
class ApprenticeTechnomancer(TechnomancerBase):
    """Generic ApprenticeTechnomancer for various expertise areas."""
    def __init__(self, expertise: str, memory_scope: str | None = None):
        cfg = ROLES["ApprenticeTechnomancerTemplate"]
        name = f"ApprenticeTechnomancer-{expertise}"
        tools = cfg.tools or []
        limits = cfg.limits
